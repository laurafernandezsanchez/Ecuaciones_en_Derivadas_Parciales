...
\begin{titlepage}
    ...
    \begin{tcolorbox}[
        ...
        {\Huge\bfseries\textcolor{mainblue!80!black}{Ecuaciones en Derivadas Parciales}} \\[0.8cm]
    ...
    {\large Basado en las clases de Antonio Linero Bas \par}
    
    \vspace{1cm}
    
    % --- ESPACIO PARA LOGO 
    \includegraphics[width=0.7\linewidth]{imágenes/Portada.png}
